...
CREATE TABLE `comments` (
  ...
  CONSTRAINT `commentauthor` FOREIGN KEY (`fk_authorId`) REFERENCES `user` (`id`),
...
CREATE TABLE `posts` (
  ...
  CONSTRAINT `postauthor` FOREIGN KEY (`fk_authorId`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-12-14 23:52:57
